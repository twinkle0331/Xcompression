...
def train_and_evaluate(args,teacher_model,student_model,train_dataloader,tokenizer,label_list ,device,output_mode,train_examples,num_labels,eval_examples,eval_labels,eval_dataloader,eval_data):
    # Train and evaluate
            ...
            if (global_step + 1) % args.eval_step == 0:
                ...
                if save_model:
                    ...
                    if args.pred_distill and task_name == "mnli":
                        ...
                        cached_features_file ="cached_{}_{}_{}_{}".format("dev", tokenizer.__class__.__name__, str(args.max_seq_len), task_name)


                        eval_features = convert_examples_to_features(
                            eval_examples, label_list, args.max_seq_len, tokenizer, output_mode, cached_features_file= cached_features_file)
...
def main():
    ...
    parser.add_argument('--aug_train',
                        action='store_true')
    parser.add_argument('--eval_stlsep',
                        type=int,
                        default=500)
    ...
    cached_features_file = "cached_{}_{}_{}_{}".format("train", tokenizer.__class__.__name__, str(args.max_seq_len),args.task_name)
    train_features = convert_examples_to_features(train_examples, label_list,
                                                  args.max_seq_len, tokenizer, output_mode,is_aug=args.aug_train, cached_features_file=  os.path.join(args.data_dir,cached_features_file))
    ...
    eval_examples = processor.get_dev_examples(args.data_dir)
    eval_features = convert_examples_to_features(eval_examples, label_list, args.max_seq_len, tokenizer, output_mode,cached_features_file= os.path.join(args.data_dir,cached_features_file))
